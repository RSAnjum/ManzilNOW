...
import 'landing_mcomp_model.dart';
export 'landing_mcomp_model.dart';

class LandingMcompWidget extends StatefulWidget {
  const LandingMcompWidget({super.key});

  @override
  State<LandingMcompWidget> createState() => _LandingMcompWidgetState();
}

class _LandingMcompWidgetState extends State<LandingMcompWidget>
    with TickerProviderStateMixin {
  late LandingMcompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LandingMcompModel());
