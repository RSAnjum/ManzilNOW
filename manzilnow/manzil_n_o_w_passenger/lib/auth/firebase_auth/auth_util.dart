...
DocumentReference? get currentUserReference =>
    loggedIn ? PassengerRecord.collection.doc(currentUser!.uid) : null;

PassengerRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : PassengerRecord.getDocument(PassengerRecord.collection.doc(uid))
              .handleError((_) {}),
    )
