...
import '/components/suggest_fare_widget.dart';
              ...
              PointerInterceptor(
                ...
                child: StreamBuilder<List<RideRequestRecord>>(
                  stream: queryRideRequestRecord(
                    queryBuilder: (rideRequestRecord) => rideRequestRecord
                        .where(
                          'is_driver_assigned',
                          isEqualTo: false,
                        )
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<RideRequestRecord> columnRideRequestRecordList =
                        snapshot.data!;
                    return Column(
                      mainAxisSize: MainAxisSize.max,
                      children: List.generate(
                          columnRideRequestRecordList.length, (columnIndex) {
                        final columnRideRequestRecord =
                            columnRideRequestRecordList[columnIndex];
                        return Container(
                          width: 500.0,
                              ...
                              children: [
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    columnRideRequestRecord.pickupAdd,
                                    'null',
                                  ),
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    columnRideRequestRecord.destinationAdd,
                                    'null',
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                ...
                                StreamBuilder<List<PassengerRecord>>(
                                  stream: queryPassengerRecord(
                                    queryBuilder: (passengerRecord) =>
                                      ...
                                      'uid',
                                      isEqualTo:
                                          columnRideRequestRecord.passengerUid,
                                    ),
                                    singleRecord: true,
                                  ),
                                  builder: (context, snapshot) {
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: custom_widgets
                                            ...
                                            endCoordinate:
                                                columnRideRequestRecord.pickup!,
                                          ),
                                        ),
                                      ].divide(const SizedBox(width: 16.0)),
                                    ),
                                ...
                                RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: valueOrDefault<String>(
                                          columnRideRequestRecord.paymentMethod,
                                          'Cash',
                                        ),
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                ...
                                if (columnRideRequestRecord.additionalReq != '')
                                  Align(
                                    alignment: const AlignmentDirectional(0.0, 0.0),
                                    child: Padding(
                                      padding: const EdgeInsets.all(10.0),
