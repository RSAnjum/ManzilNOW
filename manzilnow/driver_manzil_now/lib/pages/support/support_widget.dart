                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await launchURL('tel:2125551212');
                            },
                            child: Container(
                              width: 120.0,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await launchURL('mailto:manzilNow@gmail.com?');
                            },
                            child: Container(
                              width: 120.0,
                              constraints: const BoxConstraints(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Short Description of what You Have To Say....',
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Outfit',
                      ...
                      onPressed: () async {
                        await SupportRecord.collection
                            ...
                            .set(createSupportRecordData(
                              ...
                              phone: int.tryParse(_model.textController3.text),
                              user: 'driver',
                            ));
                        await showDialog(
                          context: context,
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: const Text(
                                  'Your Complaint/Suggestion Has Been Sent.'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
