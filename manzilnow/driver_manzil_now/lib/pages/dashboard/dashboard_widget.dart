                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('terms_condition');
                      },
                      child: Container(
                        width: double.infinity,
                        height: 50.0,
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<CompleteRideRecord>>(
                stream: queryCompleteRideRecord(
                  queryBuilder: (completeRideRecord) =>
                ...
                builder: (context, snapshot) {
                  ...
                  List<CompleteRideRecord> containerCompleteRideRecordList =
                      snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final containerCompleteRideRecord =
                      containerCompleteRideRecordList.isNotEmpty
                          ? containerCompleteRideRecordList.first
                          : null;
                  return Container(
                    width: 100.0,
                    height: 100.0,
                      ...
                      child: StreamBuilder<List<PassengerRecord>>(
                        stream: queryPassengerRecord(
                          queryBuilder: (passengerRecord) =>
                            ...
                            'uid',
                            isEqualTo:
                                containerCompleteRideRecord?.passengerUid,
                          ),
                          singleRecord: true,
                        ),
                        builder: (context, snapshot) {
                          ...
                          List<PassengerRecord> textPassengerRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          ...
                          return Text(
                            valueOrDefault<String>(
                              containerCompleteRideRecord?.rating.toString(),
                              'null',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                    ...
                    StreamBuilder<List<CompleteRideRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CompleteRideRecord>
                            listViewCompleteRideRecordList = snapshot.data!;
                              ...
                              child: StreamBuilder<List<PassengerRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<PassengerRecord>
                                      containerPassengerRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final containerPassengerRecord =
                                      containerPassengerRecordList.isNotEmpty
                                          ? containerPassengerRecordList.first
                                          : null;
                                  return Container(
                                    width: 100.0,
                                    height: 186.0,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        RatingBarIndicator(
                                          ...
                                          rating: listViewCompleteRideRecord
                                              .rating
                                              .toDouble(),
                                          unratedColor:
                                              FlutterFlowTheme.of(context)
